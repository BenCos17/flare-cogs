...
hunt = [
    ...
    "You ventured into the forest and caught a wild turkey, selling it for {amount}.",
    "You discovered a beehive and harvested honey, selling it for {amount}.",
    "You went on a safari and caught a rare animal, selling it for {amount}.",
    "You found a hidden cave and discovered a vein of precious gems, selling them for {amount}.",
    "You hunted a bear and sold its fur for {amount}.",
    "You went on a hunting trip and caught a few rabbits, selling them for {amount}.",
    "You discovered a hidden waterfall and caught some fish, selling them for {amount}.",
    "You went hunting at night and caught a few raccoons, selling their fur for {amount}.",
    "You found a hidden valley and caught a few wild goats, selling their meat for {amount}.",
    "You went hunting in the mountains and caught a few eagles, selling their feathers for {amount}.",
    "You went on a hunting expedition and caught a few wolves, selling their pelts for {amount}.",
    "You discovered a hidden meadow and caught a few deer, selling their antlers for {amount}.",
    "You went hunting in the woods and caught a few squirrels, selling their tails for {amount}.",
    "You found a hidden den and caught a few foxes, selling their fur for {amount}.",
    "You went on a hunting trip and caught a few wild boars, selling their meat for {amount}.",
    "You went hunting in the jungle and caught a few monkeys, selling them for {amount}.",
    "You discovered a hidden oasis and caught a few birds, selling their feathers for {amount}.",
    "You went on a hunting trip and caught a few lions, selling their manes for {amount}.",
    "You found a hidden savannah and caught a few giraffes, selling their hides for {amount}.",
    "You went hunting in the forest and caught a few owls, selling their feathers for {amount}.",
    "You discovered a hidden glade and caught a few deer, selling their antlers for {amount}.",
    "You went on a hunting trip and caught a few wild horses, selling them for {amount}.",
    "You found a hidden canyon and caught a few mountain lions, selling their fur for {amount}.",
    "You went hunting in the desert and caught a few snakes, selling their skins for {amount}.",
    "You discovered a hidden Oxbow lake and caught a few fish, selling them for {amount}.",
    "You went on a hunting trip and caught a few alligators, selling their hides for {amount}.",
    "You found a hidden delta and caught a few crocodiles, selling their teeth for {amount}.",
    "You went hunting in the swamp and caught a few frogs, selling their legs for {amount}.",
    "You discovered a hidden bayou and caught a few turtles, selling their shells for {amount}.",
    "You went on a hunting trip and caught a few wild turkeys, selling their feathers for {amount}.",
    "You found a hidden prairie and caught a few bison, selling their hides for {amount}.",
    "You went hunting in the badlands and caught a few coyotes, selling their fur for {amount}.",
    "You discovered a hidden mesa and caught a few rattlesnakes, selling their venom for {amount}.",
    "You went on a hunting trip and caught a few wild mustangs, selling them for {amount}.",
    "You found a hidden butte and caught a few prairie dogs, selling their fur for {amount}.",
    "You went hunting in the canyon and caught a few condors, selling their feathers for {amount}.",
    "You discovered a hidden arroyo and caught a few javelinas, selling their tusks for {amount}.",
    "You went on a hunting trip and caught a few wild donkeys, selling them for {amount}.",
    "You found a hidden seamount and caught a few sharks, selling their teeth for {amount}.",
    "You went hunting in the kelp forest and caught a few sea otters, selling their fur for {amount}.",
    "You discovered a hidden atoll and caught a few manta rays, selling their gill rakers for {amount}.",
    "You went on a hunting trip and caught a few wild boars, selling their meat for {amount}.",
    "You found a hidden mangrove and caught a few crocodiles, selling their hides for {amount}.",
    "You went hunting in the coral reef and caught a few parrotfish, selling their scales for {amount}.",
    "You discovered a hidden shipwreck and caught a few lobsters, selling them for {amount}.",
    "You went on a hunting trip and caught a few wild goats, selling their meat for {amount}.",
    "You found a hidden iceberg and caught a few seals, selling their fur for {amount}.",
    "You went hunting in the tundra and caught a few arctic foxes, selling their fur for {amount}.",
    "You discovered a hidden fjord and caught a few whales, selling their blubber for {amount}.",
    "You went on a hunting trip and caught a few wild reindeer, selling their antlers for {amount}.",
    "You found a hidden glacier and caught a few penguins, selling their feathers for {amount}.",
    "You went hunting in the ice cave and caught a few polar bears, selling their fur for {amount}.",
    "You discovered a hidden crevasse and caught a few ice worms, selling their silk for {amount}.",
    "You went on a hunting trip and caught a few wild yaks, selling their meat for {amount}.",
    "You found a hidden mountain pass and caught a few snow leopards, selling their fur for {amount}.",
    "You went hunting in the cloud forest and caught a few quetzals, selling their feathers for {amount}.",
    "You discovered a hidden volcanic crater and caught a few lava crabs, selling their shells for {amount}.",
    "You went on a hunting trip and caught a few wild llamas, selling their wool for {amount}.",
    "You found a hidden geothermal vent and caught a few giant tube worms, selling their silk for {amount}.",
    "You went hunting in the rainforest and caught a few jaguars, selling their fur for {amount}.",
    "You discovered a hidden waterfall and caught a few fish, selling them for {amount}.",
    "You went on a hunting trip and caught a few wild capybaras, selling their meat for {amount}.",
    "You found a hidden savannah and caught a few giraffes, selling their hides for {amount}.",
    "You went hunting in the grassland and caught a few pronghorns, selling their antlers for {amount}.",
    "You discovered a hidden badlands and caught a few bison, selling their hides for {amount}.",
    "You went on a hunting trip and caught a few wild horses, selling them for {amount}.",
    "You found a hidden canyon and caught a few mountain lions, selling their fur for {amount}.",
    "You went hunting in the desert and caught a few snakes, selling their skins for {amount}.",
    "You discovered a hidden oasis and caught a few birds, selling their feathers for {amount}.",
    "You went on a hunting trip and caught a few wild donkeys, selling them for {amount}.",
    "You found a hidden delta and caught a few crocodiles, selling their hides for {amount}.",
    "You went hunting in the swamp and caught a few frogs, selling their legs for {amount}.",
    "You discovered a hidden bayou and caught a few turtles, selling their shells for {amount}.",
    "You went on a hunting trip and caught a few wild turkeys, selling their feathers for {amount}.",
    "You found a hidden prairie and caught a few bison, selling their hides for {amount}.",
...
fish = [
    ...
    "You went ice fishing and caught a giant pike, selling it for {amount}.",
    "You discovered a school of exotic fish and sold them to a aquarium for {amount}.",
    "You went fishing in the ocean and caught a massive tuna, selling it for {amount}.",
    "You found a hidden underwater cave and discovered a treasure chest filled with pearls, selling them for {amount}.",
    "You went fishing in a river and caught a giant catfish, selling it for {amount}.",
    "You caught a bucket of fish and sold them at the market for {amount}.",
    "You went fly fishing and caught a beautiful trout, selling it for {amount}.",
    "You discovered a secret fishing hole and caught a record-breaking bass, selling it for {amount}.",
    "You went fishing with a friend and caught a pair of matching fish, selling them for {amount}.",
    "You caught a fish with a golden scale and sold it to a collector for {amount}.",
    "You went fishing at dawn and caught a school of fish, selling them for {amount}.",
    "You caught a fish that was almost as big as your boat, selling it for {amount}.",
    "You discovered a hidden lake and caught a giant sturgeon, selling it for {amount}.",
    "You went fishing in the dark and caught a glowing fish, selling it for {amount}.",
    "You caught a fish that was rumored to have magical powers, selling it for {amount}.",
    "You went fishing in a storm and caught a fish that was swept away by the current, selling it for {amount}.",
    "You discovered a sunken ship and caught a fish that was hiding in the wreckage, selling it for {amount}.",
    "You caught a fish that was older than you, selling it for {amount}.",
    "You went fishing in a waterfall and caught a fish that was swimming upstream, selling it for {amount}.",
    "You discovered a hidden waterfall and caught a fish that was hiding behind it, selling it for {amount}.",
    "You caught a fish that was as colorful as a rainbow, selling it for {amount}.",
    "You went fishing in a swamp and caught a fish that was as slippery as an eel, selling it for {amount}.",
    "You discovered a hidden swamp and caught a fish that was as big as a log, selling it for {amount}.",
    "You caught a fish that was as fast as a torpedo, selling it for {amount}.",
    "You went fishing in a glacier and caught a fish that was frozen in the ice, selling it for {amount}.",
    "You discovered a hidden glacier and caught a fish that was as white as snow, selling it for {amount}.",
    "You caught a fish that was as strong as a shark, selling it for {amount}.",
    "You went fishing in a volcano and caught a fish that was swimming in the lava, selling it for {amount}.",
    "You discovered a hidden volcano and caught a fish that was as hot as fire, selling it for {amount}.",
    "You caught a fish that was as old as the earth, selling it for {amount}.",
    "You went fishing in a tornado and caught a fish that was swept away by the wind, selling it for {amount}.",
    "You discovered a hidden tornado and caught a fish that was as fast as the wind, selling it for {amount}.",
    "You caught a fish that was as wise as a sage, selling it for {amount}.",
    "You went fishing in a hurricane and caught a fish that was riding the storm, selling it for {amount}.",
    "You discovered a hidden hurricane and caught a fish that was as powerful as the storm, selling it for {amount}.",
    "You caught a fish that was as mysterious as the deep, selling it for {amount}.",
    "You went fishing in a tsunami and caught a fish that was surfing the wave, selling it for {amount}.",
    "You discovered a hidden tsunami and caught a fish that was as strong as the wave, selling it for {amount}.",
    "You caught a fish that was as elusive as a ghost, selling it for {amount}.",
    "You went fishing in a drought and caught a fish that was as rare as a unicorn, selling it for {amount}.",
    "You discovered a hidden drought and caught a fish that was as precious as a gem, selling it for {amount}.",
    "You caught a fish that was as ancient as the pyramids, selling it for {amount}.",
    "You went fishing in a flood and caught a fish that was swimming against the current, selling it for {amount}.",
    "You discovered a hidden flood and caught a fish that was as resilient as a phoenix, selling it for {amount}.",
    "You caught a fish that was as majestic as a king, selling it for {amount}.",
    "You went fishing in a desert and caught a fish that was as rare as a mirage, selling it for {amount}.",
    "You discovered a hidden desert and caught a fish that was as elusive as a mirage, selling it for {amount}.",
    "You caught a fish that was as vibrant as a rainbow, selling it for {amount}.",
    "You went fishing in a forest and caught a fish that was as sneaky as a snake, selling it for {amount}.",
    "You discovered a hidden forest and caught a fish that was as agile as a monkey, selling it for {amount}.",
    "You caught a fish that was as cunning as a fox, selling it for {amount}.",
    "You went fishing in a mountain and caught a fish that was as strong as a bear, selling it for {amount}.",
    "You discovered a hidden mountain and caught a fish that was as fierce as a dragon, selling it for {amount}.",
    "You caught a fish that was as gentle as a lamb, selling it for {amount}.",
    "You went fishing in a valley and caught a fish that was as peaceful as a dove, selling it for {amount}.",
    "You discovered a hidden valley and caught a fish that was as serene as a swan, selling it for {amount}.",
    "You caught a fish that was as playful as a dolphin, selling it for {amount}.",
    "You went fishing in a city and caught a fish that was as clever as a rat, selling it for {amount}.",
    "You discovered a hidden city and caught a fish that was as resourceful as a cockroach, selling it for {amount}.",
    "You caught a fish that was as adaptable as a chameleon, selling it for {amount}.",
    "You went fishing in a jungle and caught a fish that was as stealthy as a jaguar, selling it for {amount}.",
    "You discovered a hidden jungle and caught a fish that was as agile as a monkey, selling it for {amount}.",
    "You caught a fish that was as resilient as a cockroach, selling it for {amount}.",
    "You went fishing in a tundra and caught a fish that was as hardy as a polar bear, selling it for {amount}.",
    "You discovered a hidden tundra and caught a fish that was as tough as a walrus, selling it for {amount}.",
    "You caught a fish that was as majestic as an eagle, selling it for {amount}.",
    "You went fishing in a savannah and caught a fish that was as swift as a cheetah, selling it for {amount}.",
    "You discovered a hidden savannah and caught a fish that was as agile as a gazelle, selling it for {amount}.",
    "You caught a fish that was as cunning as a hyena, selling it for {amount}.",
    "You went fishing in a grassland and caught a fish that was as fast as a pronghorn, selling it for {amount}.",
    "You discovered a hidden grassland and caught a fish that was as nimble as a rabbit, selling it for {amount}.",
    "You caught a fish that was as gentle as a deer, selling it for {amount}.",
    "You went fishing in a wetland and caught a fish that was as slippery as an eel, selling it for {amount}.",
    "You discovered a hidden wetland and caught a fish that was as stealthy as a snake, selling it for {amount}.",
    "You caught a fish that was as ancient as a dinosaur, selling it for {amount}.",
    "You went fishing in a canyon and caught a fish that was as strong as a condor, selling it for {amount}.",
    "You discovered a hidden canyon and caught a fish that was as fierce as a hawk, selling it for {amount}.",
    "You caught a fish that was as majestic as a mountain lion, selling it for {amount}.",
    "You went fishing in a delta and caught a fish that was as cunning as a crocodile, selling it for {amount}.",
    "You discovered a hidden delta and caught a fish that was as agile as a monkey, selling it for {amount}.",
    "You caught a fish that was as resilient as a cockroach, selling it for {amount}.",
    "You went fishing in a bayou and caught a fish that was as stealthy as a snake, selling it for {amount}.",
    "You discovered a hidden bayou and caught a fish that was as slippery as an eel, selling it for {amount}.",
    "You caught a fish that was as ancient as a dinosaur, selling it for {amount}.",
    "You went fishing in a prairie and caught a fish that was as fast as a pronghorn, selling it for {amount}.",
    "You discovered a hidden prairie and caught a fish that was as agile as a rabbit, selling it for {amount}.",
    "You caught a fish that was as gentle as a deer, selling it for {amount}.",
    "You went fishing in a badlands and caught a fish that was as strong as a bison, selling it for {amount}.",
    "You discovered a hidden badlands and caught a fish that was as fierce as a hawk, selling it for {amount}.",
    "You caught a fish that was as majestic as a mountain lion, selling it for {amount}.",
    "You went fishing in a mesa and caught a fish that was as cunning as a coyote, selling it for {amount}.",
    "You discovered a hidden mesa and caught a fish that was as agile as a lizard, selling it for {amount}.",
    "You caught a fish that was as resilient as a cockroach, selling it for {amount}.",
    "You went fishing in an arroyo and caught a fish that was as stealthy as a snake, selling it for {amount}.",
    "You discovered a hidden arroyo and caught a fish that was as slippery as an eel, selling it for {amount}.",
    "You caught a fish that was as ancient as a dinosaur, selling it for {amount}.",
    "You went fishing in a butte and caught a fish that was as fast as a pronghorn, selling it for {amount}.",
    "You discovered a hidden butte and caught a fish that was as agile as a rabbit, selling it for {amount}.",
    "You caught a fish that was as gentle as a deer, selling it for {amount}.",
    "You went fishing in a seamount and caught a fish that was as strong as a shark, selling it for {amount}.",
    "You discovered a hidden seamount and caught a fish that was as fierce as a dragon, selling it for {amount}.",
    "You caught a fish that was as majestic as a king, selling it for {amount}.",
]
